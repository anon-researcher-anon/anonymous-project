...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data-dir', metavar='DIR', default='data-dir', help='path to dataset')
    ...
    # Model parameters
    parser.add_argument('--model', default='model-name', type=str, metavar='MODEL',
                        help='Name of model to train (default: "overlock_xt"')
    ...
    parser.add_argument('--patience-epochs', type=int, default=40, metavar='N',
...
def main(args):
    ...
    if args.distributed:
        ...
        _logger.info('Training with a single process on GPU 1.')
    assert args.rank >= 0
